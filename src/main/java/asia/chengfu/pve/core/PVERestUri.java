...
enum PVERestUri {
    ...
    ACCESS_ACL("/api2/json/access/acl"),
    ...
    NODES_QEMU_AGENT_EXEC("/api2/json/nodes/{node}/qemu/{vmid}/agent/exec"),
    ...
    NODES_QEMU_STATUS_REBOOT("/api2/json/nodes/{node}/qemu/{vmid}/status/reboot"),
